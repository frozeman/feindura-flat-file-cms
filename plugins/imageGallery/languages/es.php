...
$pluginLangFile['feinduraPlugin_title']        = 'Galeria de imágenes';
$pluginLangFile['feinduraPlugin_description']  = 'Muestra una galeria de imágenes. Las miniaturas de las imágenes se crean automáticamente. Al pinchar sobre una imagen ésta se mostrará a tamaño completo en un <a href="http://reghellin.com/milkbox/" target="_blank">panel (lightbox)</a>.';
