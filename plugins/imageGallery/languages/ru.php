...
$pluginLangFile['feinduraPlugin_description']  = 'Списки изображений в галерее. Он автоматически создает миниатюры для каждого изображения. При нажатии на изображение, оно будет показано в полном размере <a href="http://reghellin.com/milkbox/">lightbox</a>.';
