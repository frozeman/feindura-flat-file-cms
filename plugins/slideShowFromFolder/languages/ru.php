...
$pluginLangFile['feinduraPlugin_description']  = 'Создание слайд-шоу из изображений в папке. Изображения будут автоматически изменяется до заданного размера. посмотреть <a href="http://www.johannes-fischer.de/labs/nivoo-slider/">Nivooslider</a>.';

/* CONFIG ************************************************************************************ */

$pluginLangFile['path']               = 'Путь к изображениям';
$pluginLangFile['path_tip']           = 'абсолютный путь folderr, которая содержит изображения::например &quot;/upload/slideshow1&quot;';
