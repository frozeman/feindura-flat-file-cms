...
// Load this file's selection again by visiting: http://mootools.net/more/6f1c575fbe59ea877722b049d7247760 
// Or build this file again with packager using: packager build More/More More/Class.Binds More/Chain.Wait More/Array.Extras More/Object.Extras More/String.Extras More/String.QueryString More/Hash More/Hash.Extras More/Elements.From More/Element.Measure More/Element.Pin More/Element.Position More/Form.Request More/OverText More/Fx.Elements More/Fx.Move More/Fx.Reveal More/Fx.Scroll More/Fx.Slide More/Fx.SmoothScroll More/Fx.Sort More/Drag More/Drag.Move More/Sortables More/Request.Queue More/Assets More/Color More/Scroller More/Tips
/*
---
copyrights:
...
if(!this.options.stopOnFailure&&this.options.autoAdvance){this.runNext();}this.fireEvent("exception",arguments);}});var Asset={javascript:function(d,b){if(!b){b={};
...
return(b)?b.rgbToHsb():null;},hsbToRgb:function(){var b=this.match(/\d{1,3}/g);return(b)?b.hsbToRgb():null;}});})();var Scroller=new Class({Implements:[Events,Options],options:{area:20,velocity:1,onChange:function(a,b){this.element.scrollTo(a,b);
