		...
		extend( line, {
			...
			lineChildren: [
				extend(
					...
					base: CSS_COMMON + 'height:17px;width:17px;' + ( that.rtl ? 'right' : 'left' ) + ':17px;'
						+ 'background:url(' + this.path + 'images/icon.png) center no-repeat ' + that.boxColor + ';color:transparent;cursor:pointer;'
