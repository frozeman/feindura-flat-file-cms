...
FileManager.Language.fr = {
	...
	'upload.disabled': 'Le téléversement de fichier a été désactivé sur ce serveur.',
	'upload.authenticated': 'Vous n\'êtes pas authentifié et ne pouvez pas téléverser de fichier.',
	'upload.path': 'Le répertoire de téléversement spécifié n\'existe pas. Merci de contacter l\'administrateur de ce site Internet.',
	'upload.exists': 'Le chemin de téléversement spécifié existe déjà. Merci de contacter l\'administrateur de ce site Internet.',
	'upload.mime': 'Le type de fichier spécifié n\'est pas autorisé.',
	'upload.extension': 'Le fichier téléversé a une extension inconnue ou interdite.',
	'upload.size': 'La taille de votre fichier est trop grande pour être téléversée sur ce serveur. Merci de sélectionner un fichier moins lourd.',
	'upload.partial': 'Le fichier a été partiellement téléversé, merci de recommencer l\'opération.',
	'upload.nofile': 'Aucun fichier n\'a été spécifié.',
	'upload.default': 'Une erreur s\'est produite.',
