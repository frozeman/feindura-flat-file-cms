  ...
  <div class="content brown">
    ...
    if($pages = GeneralFunctions::loadPages(0,true)) {
      ...
      foreach($pages as $page) {
        ...
        echo '<li><a href="?category=0&amp;page='.$page['id'].'" tabindex="'.$tabIndex.'"'.$pageSelected.'><span>'.strip_tags(GeneralFunctions::getLocalized($page,'title')).'</span><span style="display:none;" class="toolTip noMark notSavedSignPage'.$page['id'].'" title="'.$langFile['EDITOR_pageNotSaved'].'::"> *</span></a></li>';
        $tabIndex++;
      }
    } else {
    ...
    <div class="content white">
      ...
      if($pages = GeneralFunctions::loadPages($_GET['category'],true)) { 
        ...
        foreach($pages as $page) {
          ...
          echo '<li><a href="?category='.$page['category'].'&amp;page='.$page['id'].'" tabindex="'.$tabIndex.'"'.$pageSelected.'><span>'.GeneralFunctions::getLocalized($page,'title').'</span><span style="display:none;" class="toolTip noMark notSavedSignPage'.$page['id'].'" title="'.$langFile['EDITOR_pageNotSaved'].'::"> *</span></a></li>';
          $tabIndex++;
        }       
      } else {
        echo '<li><a href="#" onclick="return false;"><span>'.$langFile['SORTABLEPAGELIST_categoryEmpty'].'</span></a></li>';
