...
// QUESTION
echo '<h1>'.$langFile['pageSetup_deletCategory_question_part1'].' &quot;<span style="color:#000000;">'.$categories['id_'.$_GET['category']]['name'].'</span>&quot; '.$langFile['pageSetup_deletCategory_question_part2'].'</h1>';
