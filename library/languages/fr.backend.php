...
$langFile['STYLESHEETS_TOOLTIP_STYLEFILE'] = 'Ici des feuilles de style peuvent &ecirc;tre indiqu&eacute;es pour l\'utilisation dans le html &eacute;diteur afin de former le contenu.';
$langFile['STYLESHEETS_TOOLTIP_ID'] = 'Ici un attribut ID peut &ecirc;tre indiqu&eacute; pour l\'attribuer au tag de l\'&eacute;diteur HTML-Editor &lt;body&gt;.';
$langFile['STYLESHEETS_TOOLTIP_CLASS'] = 'Ici un attribut class peut &ecirc;tre indiqu&eacute; pour l\'attribuer au tag de l\'&eacute;diteur HTML-Editor &lt;body&gt;.';
...
$langFile['STATISTICS_TOOLTIP_SPIDERCOUNT'] = 'robot d\'indexation::aussi nomm&eacute; Webcrawler sont des scripts des moteurs de recherche qui analysent et indicent des sites web.';
...
$langFile['LOG_PAGE_SORTED'] = 'page mis &agrave; l\'lordre';
...
$langFile['LOG_ADMINSETUP_SAVED'] = 'nouveaux pr&eacute;f&eacute;rences l\'administrateur sauvegard&eacute;';
$langFile['LOG_ADMINSETUP_CKSTYLES'] = '"choix des syles" de l\'&eacute;diteur HTML sauvegard&eacute;';
...
$langFile['USER_TEXT_CURRENTUSER'] = 'Tu es connect&eacute; en tant qu\'utilisateurs';
...
$langFile['ERROR_SAVE_FILE'] = '<br /><br />Svp contr&ocirc;lez les droits d\'&eacute;criture du fichier:';

$langFile['ERROR_READ_FOLDER_PART1'] = '<br /><br />Svp contr&ocirc;lez les droits de lecture des "';
$langFile['ERROR_SAVE_FOLDER_PART1'] = '<br /><br />Svp contr&ocirc;lez les droits d\'&eacute;criture des "';
...
$langFile['warning_startPageWarning_h1'] = 'La page d\'acceuil n\'est pas d&eacute;finie.';
$langFile['warning_startPageWarning'] = 'Svp d&eacute;finissez une page d\'acceuil.<br />Gehe zu <a href="?site=pages">'.$langFile['BUTTON_PAGES'].'</a> und klicke bei der gew&uuml;nschten Seite auf das <span class="startPageIcon"></span> Symbol';
$langFile['warning_fmsConfWarning_h1'] = '<span class="logoname">fein<span>dura</span></span> n\'a pas encore &eacute;t&eacute; configur&eacute;!';
$langFile['warning_fmsConfWarning'] = 'La <i>trace de base</i>ne correspond pas avec les pr&eacute;f&eacute;rences l\'administrateur.<br />
...
Cliquez sur s&eacute;curit&eacute; ou sur "standard" ou bien "adapter standard" et puis activez le "activer Active Scripting" sous l\'onglet. Validez avec ok.</p>
...
$langFile['warning_ieOld'] = 'Pour <span class="logoname">fein<span>dura</span></span> utiliser le CMS enti&egrave;rement, version 7 de l\'IE est n&eacute;cessaire.<br /><br />Svp installez une nouvelle version de l\'Internet Explorer,<br /> ou bien installez <a href="http://www.google.com/chromeframe" target="_blank">Google Chrome Frame Plugin</a> pour l\'IE,<br /> ou bien t&eacute;l&eacute;chargez <a href="http://www.mozilla.org/firefox/">Firefox Browser</a>.';
...
$langFile['sortablePageList_changeStatusPage_error_save'] = '<b>le status du site web ne pouv&eacute; pas &ecirc;tre chang&eacute;.</b>'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
$langFile['sortablePageList_changeStatusCategory_error_save'] = '<b>le status de la cat&eacute;gorie ne pouv&eacute; pas &ecirc;tre chang&eacute;.</b>'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
$langFile['sortablePageList_info'] = 'L\'ordre du site web peut &ecirc;tre chang&eacute; <b>ordre site web</b> par <b>Drag and Drop</b> ainsi que les pages peuvent &ecirc;tre interchang&eacute;es entre les cat&eacute;gories diff&eacute;rentes.';
...
$langFile['sortablePageList_error_save'] = '<b>les pages ne pouvaient pas &ecirc;tre sauvgard&eacute;es.</b>'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
$langFile['sortablePageList_error_read'] = '<b>les pages ne pouvaient pas &ecirc;tre lus.</b>'.$langFile['ERROR_READ_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
$langFile['sortablePageList_error_move'] = '<b>la page ne pouvait pas &ecirc;tre mise dans la nouvelle cat&eacute;gorie.</b>'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
...
// ---------- editor Settings
$langFile['adminSetup_editorSettings_h1'] = 'param&egrave;tres de l\'&eacute;diteur HTML';
...
// ---------- styleFile Settings
$langFile['adminSetup_styleFileSettings_h1'] = 'adapter le "choix du style" dans l\'&eacute;diteur HTML';
...
$langFile['editFilesSettings_createFile_inputTip'] = 'Si vous mettez le nom d\'un fichier ici, un nouveau fichier sera cr&eacute;e,[br /]et [b]le donn&eacute;e choisi actuellement ne sera pas sauvegard&eacute;![/b]';
...
$langFile['pageSetup_pageConfig_check1'] = 'la page d\'acceuil peut &ecirc;tre d&eacute;finie';
$langFile['pageSetup_pageConfig_check1_tip'] = 'la page d\'acceuil peut &ecirc;tre d&eacute;finie par l\'utilisateur.[br /][br /]La page d\'acceuil d&eacute;finie sera publi&eacute;, si aucune variable du site web sera transmise ou bien la page ne sera pas &eacute;xecut&eacute;e.';
...
$langFile['pageSetup_pageConfig_check2_tip'] = 'D&eacute;finit si l\'utilisateur peut cr&eacute;er/&eacute;ffacer une page sans cat&eacute;gorie.';
$langFile['pageSetup_pageConfig_check3'] = 't&eacute;l&eacute;charger thumbnails';
$langFile['pageSetup_pageConfig_check3_tip'] = 'D&eacute;finit si l\'utilisateur peut t&eacute;l&eacute;charger des thumbnails au sein des pages sans cat&eacute;gories.';
$langFile['pageSetup_pageConfig_check4'] = 'traiter tags';
$langFile['pageSetup_pageConfig_check4_tip'] = 'D&eacute;finit si l\'utilisateur peut traiter des tags au sein des pages sans cat&eacute;gories.[br /]'.$langFile['pageSetup_general_tag_tip'];
$langFile['pageSetup_pageConfig_check5'] = 'activer plugins';
$langFile['pageSetup_pageConfig_check5_tip'] = 'D&eacute;finit si l\'utilisateur peut utiliser des plugins au sein des pages.';
...
$langFile['pageSetup_createCategory_unnamed'] = 'cat&eacute;gorie n\'est pas nomm&eacute;';
...
$langFile['pageSetup_error_createDir'] = '<b>Un r&eacute;pertoire de cat&eacute;gorie ne pouvait pas &ecirc;tre cr&eacute;e.</b>'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.'" Ordners.';
...
$langFile['pageSetup_error_deleteDir'] = '<b>Le r&eacute;pertoire de cat&eacute;gorie ne pouvait pas &ecirc;tre &eacute;ffac&eacute;.</b>'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
...
$langFile['pageSetup_check6_tip'] = 'les pages seront tri&eacute; par ordre chronologique.[br /][br /][span class=hint]Manuellement trier n\'est plus possible.[/span]';
...
$langFile['websiteSetup_websiteConfig_field5_tip'] = 'Une courte description de votre site web utilis&eacute; par les moteurs de recherche. Les mots-cl&eacute; se trouveront dans l\'URL du site web mais dans le contenu.';
...
$langFile['statisticSetup_clearStatistics_websiteStatistic_tip'] = '[b]Contient[/b][ul][li]tout le nombre des visiteurs[/li][li]nombre des robots d\'indexation[/li][li]date de la premi&egrave;re visite[/li][li]date de la derni&egrave;re visite[/li][li]spectre des navigateurs utilis&eacute;s[/li][/ul]';
...
$langFile['statisticSetup_clearStatistic_pagesStatistics_error_read'] = 'une erreur s\'est produite pendant l\'&eacute;ffacement des statistiques du site web.'.$langFile['ERROR_SAVE_FOLDER_PART1'].$adminConfig['basePath'].'pages/'.$langFile['ERROR_FOLDER_PART2'];
...
$langFile['editor_pageSettings_field2_tip_inputTip'] = 'les tags doivent &ecirc;tre s&eacute;par&eacute;s par la [b]barre d\'espacement[/b].';
$langFile['editor_pageSettings_field3'] = 'date du site web';
$langFile['editor_pageSettings_field3_tip'] = 'La date peut &ecirc;tre utilis&eacute;e pour trier les pages dans l\'ordre chronologique. (par ex. des &eacute;venements)';
...
$langFile['editor_pageSettings_pagedate_error_tip'] = 'Ce mois n\'a peut &ecirc;tre pas 31 jours.[br /]La date devrait avoir le format suivant:';
...
$langFile['editor_advancedpageSettings_stylesheet_ifempty'] = 'Quand toutes les cases sont vides, les param&egrave;tres des feuilles de style de la cat&eacute;gorie seront utilis&eacute;s. Si ceux-ci sont vides aussi, les param&egrave;tres de l\'&eacute;diteur HTML seront utlis&eacute;s.';
...
$langFile['pagethumbnail_thumbsize_h1'] = 'd&eacute;finir la taille de l\'image';
