...
if(is_file(dirname(__FILE__).'/../../../pages/'.$categoryPath.$page.'.php')) {
  $question = '<h1 class="red">'.$langFile['deletePage_question_part1'].' &quot;<span style="color:#000000;">'.strip_tags(GeneralFunctions::getLocalized($pageContent['localized'],'title')).'</span>&quot; '.$langFile['deletePage_question_part2'].'</h1>';
