...
// QUESTION
echo '<h1 class="red">'.$langFile['PAGESETUP_CATEGORY_TEXT_DELETECATEGORY_QUESTION_START'].' <span style="color:#000000;">'.$categoryConfig[$_GET['category']]['name'].'</span> '.$langFile['PAGESETUP_CATEGORY_TEXT_DELETECATEGORY_QUESTION_END'].'</h1>';
