...
<?php echo htmlspecialchars(GeneralFunctions::getLocalized($pageContent['localized'],'content',true),ENT_NOQUOTES,'UTF-8'); ?>
</textarea>
<?php
...
window.addEvent('domready',function(){
  ...
  CKEDITOR.config.language                  = '<?php echo $_SESSION["feinduraSession"]["language"]; ?>';
