...
Source Location: {$source_location}<br />
{$class_name.slink}<br />
...
<div class="info-box">
	...
	<div class="nav-bar">
		...
		{if $vars || $ivars}
			{if $vars}
				| <a href="#sec-var-summary">Property Summary</a> | <a href="#sec-vars">Properties Description</a>
			{else}
	...
	<div class="info-box">
		...
		<div class="nav-bar">
			...
			{if $ivars || $imethods || $iconsts}
				| <a href="#sec-inherited">Inherited Properties and Methods</a>
			{/if}
			| <span class="disabled">Property Summary</span> | <a href="#sec-vars">Properties Description</a>
			{if $methods || $imethods}
				{if $methods}
					| <a href="#sec-method-summary">Method Summary</a> | <a href="#sec-methods">Methods Detail</a>
				{else}
...
{if $vars || $ivars}
	...
	<div class="info-box">
		...
		<div class="nav-bar">
			...
			{/if}
			{if $methods}
				| <a href="#sec-var-summary">Property Summary</a> | <span class="disabled">Properties Description</span>
			{else}
